...
void TrackStudy::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PrHit_Size", PrHit_Size, &b_PrHit_Size);
   ...
   fChain->SetBranchAddress("fromDecay", &fromDecay, &b_fromDecay);
   fChain->SetBranchAddress("fromPrimaryVertex", &fromPrimaryVertex, &b_fromPrimaryVertex);
