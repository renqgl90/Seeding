...
// Tue Jun 30 14:54:23 2015 by ROOT version 6.02/08
// from TTree TrackStudy/Events
// found on file: SciFi-Tuple-Debug_1000_AllNew.root
//////////////////////////////////////////////////////////

#ifndef Track_Study_h
#define Track_Study_h
...
class Track_Study : public TSelector {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Track_Study(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Track_Study() { }
   ...
   ClassDef(Track_Study,0);
};

#endif

#ifdef Track_Study_cxx
void Track_Study::Init(TTree *tree)
{
